...
scene.fog = new THREE.Fog(0x9ec7e3, 70, 170);
...
const textureFiles = {
  grass: 'grass.jpg', dirt: 'dirt.jpg', stone: 'stone.jpg', sand: 'sand.jpg',
  leaves: 'leaves.jpg', trunk: 'trunk.jpg', water: 'water.jpg', snow: 'snow.jpg',
  mountain: 'mountain.jpg', plains: 'plains.jpg', forest: 'forest.jpg', jungle: 'jungle.jpg',
  taiga: 'taiga.jpg', desert: 'desert.jpg', beach: 'beach.jpg'
};
...
for (const [type, filename] of Object.entries(textureFiles)) {
  ...
  textureLoader.load(`./assets/textures/${filename}`, loaded => {
...
$('#randomSeed').addEventListener('click', () => { $('#seed').value = Math.floor(Math.random() * 999999999); regenerate(); });
...
for (const button of document.querySelectorAll('[data-block]')) button.addEventListener('click', () => selectBlock(button.dataset.block));
